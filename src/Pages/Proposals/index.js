...
const api = "http://localhost:2001/app"
...
export default () => {
  ...
  const [projectModalItem, setProjectModalItem] = React.useState(null)
    ...
    {modalOpen &&
      ...
      >
        <div className={style.modalContent}>
          ...
          <textarea typeof='input'  className={style.modalText} onChange={(e) => {setProposal(e.target.value); console.log(proposal);}} >
